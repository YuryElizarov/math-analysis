...
const s = {
  ...
  install(t, e) {
    t != null && t.version && +t.version.split(".")[0] >= 3 ? t.config.globalProperties.$mathlive = e : Object.defineProperty(t.prototype, "$mathlive", {value: e}), t.component("mathlive-mathfield", this)
  },
  watch: {
    value(t, e) {
      let i = this.$el.getValue();
      t !== i && this.$el.setValue(t, {suppressChangeNotifications: !0})
    }, options: {
      deep: !0, handler(t, e) {
